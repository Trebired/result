...
const PACKAGE_NAME = toTrimmedString(packageJson?.name) || `@${PACKAGE_ORGANIZATION_NAME}/result`;
const PACKAGE_VERSION = toTrimmedString(packageJson?.version, "1.2.2");
const PACKAGE_SLUG = packageSlug(PACKAGE_NAME) || "result";
