...
Thanks for helping improve `@trebired/result`.
...
- Keep result builders and responders transport-agnostic.
- Keep i18n local to explicit caller-provided bundles.
- Keep stable result codes separate from localized messages.
- Avoid framework, route, frontend, or platform assumptions.
